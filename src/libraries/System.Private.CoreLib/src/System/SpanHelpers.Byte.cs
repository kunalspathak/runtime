...
namespace System
{
    ...
    public static byte Kunal1(ref byte first)
    {
        return Sse2.IsSupported ? first : (byte)(first + 1);
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public static byte Kunal2(ref byte first)
    {
        return AdvSimd.Arm64.IsSupported ? first : (byte)(first + 1);
    }
